...
def training(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    """
    ...
    for img_path in image_files_in_folder(os.path.join(train_dir)):
            ...
            suspectName = suspectName[len(suspectName)-1].split('.')[0]
